<div align="center">
  <h1>:wave: Olar, sou o <!-- AUTOREADME:NAME --></h1>
</div>
...
<div align="center">
  ...
  <p>Código do dia: <b><!-- AUTOREADME:DAILY_CODE_NAME --></b></p>
  
  <div align="left">

<!-- AUTOREADME:DAILY_CODE -->
...
<h1>:chart_with_upwards_trend: statistics :chart_with_upwards_trend:</h1>
  <a href="https://github.com/Lobooooooo14" target="_blank">
    <img src="https://github.com/Lobooooooo14/tests/blob/renders-output/metrics.plugin.languages.svg" alt="most used languages" width="600px">
  <a href="https://github.com/Lobooooooo14" target="_blank">
      <img src="https://github.com/Lobooooooo14/tests/blob/renders-output/metrics.plugin.isocalendar.fullyear.svg" alt="year commits calendar" width="400px">
    </a>
  </a>
</div>
    ...
    <table>
        ...
        <tr>
            <td width="100px" align="center">
                <!-- AUTOREADME:FOLLOWERS_ACTIVE_TOP_3 -->
            </td>
            <td width="fit-content" align="left">
                <!-- AUTOREADME:FOLLOWERS_ACTIVE_LEADERBOARD -->
            </td>
        </tr>
    </table>
</div>
